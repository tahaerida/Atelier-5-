...
class Vecteur2D:
    ...
    def __str__(self):
        # en return la valeur de x et y 
        return "x = %d, y = %d" % (self.x, self.y)


# programme principale
if __name__ == '__main__':
    print(" le vecteur est initialisé par (0,0) ")
    print(Vecteur2D())
    print(" en donne des valeurs a vecteur ")
...
# programme principal -----------------------------------------------
vect1, vect2 = Vecteur2D(5.7, 2.7), Vecteur2D(4.9, 5.1)
print(vect1)
print(vect2)
print(vect1 + vect2)
